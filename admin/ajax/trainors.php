<?php
    ...
    if(isset($_POST['add_trainor']))
    {
        ...
        $q1 = "INSERT INTO `trainor` (`name`, `info`) VALUES (?,?)";
        $values = [$frm_data['name'],$frm_data['info']];
    ...
    if(isset($_POST['update_trainor']))
    {
        ...
        $q1 = "UPDATE `trainor` SET `name`=?, `info`=? WHERE `trainor_id`=?";
        $values = [$frm_data['name'], $frm_data['info'], $frm_data['trainor_id']];
