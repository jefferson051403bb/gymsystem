                ...
                <?php 
                    ...
                    <div class="card mb-4 border-0 shadow">
                        <div class="row g-0 p-3">
                            <div class="col-md-4 mb-lg-0 mb-md-0 mb-3" style="display:flex; justify-content:center; align-items:center; overflow: hidden; max-height: 500px; height: 500px; background-size: cover; background-position: center;">
